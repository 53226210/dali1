...
function calcul(){
    ...
    y5=parseFloat(document.getElementById("T47").value)
    c5=parseFloat(document.getElementById("T22").value)
    s5=(((c5*2)+x5+y5)/4)
    islamique=document.getElementById("T23").value=Math.floor(s5*100)/100
    setTimeout("calcul()",islamique)
    ...
    s6=(((c6*2)+y6+x6)/4)
    civique=document.getElementById("T27").value=Math.floor(s6*100)/100
    setTimeout("calcul()",civique)



    x7=parseFloat(document.getElementById("T48").value)
    ...
    s10=(((c10*2)+y10+x10)/4)
    Technique=document.getElementById("T42").value=Math.floor(s10*100)/100
    setTimeout("calcul()",Technique)
    ...
    cc1=(((h*2)+(h1*2)+(Anglais*2)+Histoire+Géographie+islamique+civique+(math*4)+(Physique*3)+(Programmation*3)+(Technique*2)+Sport)/23)
    }
    if (document.getElementById('C1').checked==true){
        cc1=((h+(h1*2)+(Anglais*2)+Histoire+Géographie+islamique+civique+(math*4)+(Physique*3)+(Programmation*3)+(Technique*2))/22)
    }
